    ...
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <div class="col-xl-7 col-lg-9 text-center">
          <h1>We apply to 1,000+ jobs for you or reach out to 1,000+ hiring managers for you per month.</h1>
      ...
      <div class="text-center mb-5">
        ...
        <a href="#" class="btn-get-started scrollto fw-bold text-black bg-light"> Book a Call Now</a>
        <a href="{{ route('page.see-action') }}" class="btn-get-started scrollto fw-bold text-black">SEE IT IN ACTION</a>
      </div>
